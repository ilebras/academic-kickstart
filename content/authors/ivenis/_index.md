...
# Role/position
role: Postdoc<br />WHOI<br />Physical Oceanography
...
- icon: envelope
  icon_pack: fas
  link: 'ivenis.pita@whoi.edu'  # For a direct email link, use "mailto:test@example.org".
...
- icon: cv
icon_pack: ai
link: https://ivenispita.github.io/science_mode/
